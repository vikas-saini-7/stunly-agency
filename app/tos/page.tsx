    ...
    <>
      ...
      <div className="container">
        ...
        <ul>
          ...
          <li>
            <p>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Stunly Agency, Pune.</p>
          </li>
          <li>
          ...
          <li>
            <p>Website refers to Stunly Agency, accessible from&nbsp;<u><a href="https://stunly-agency.com/" rel="external nofollow noopener" target="_blank">https://stunly-agency.com/</a></u></p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email:&nbsp;stunlyagency@gmail.com</p>
          </li>
          <li>
            <p>By visiting this page on our website:&nbsp;<u><Link href="/" rel="external nofollow noopener">https://stunly-agency.com/</Link></u></p>
          </li>
          <li>
            <p>By phone number: (+91) 7972 1514 99</p>
          </li>
        </ul>
        </div>
      </div>
