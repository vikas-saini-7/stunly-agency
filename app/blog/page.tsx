    ...
    <>
      ...
      <section className="pt-[120px] pb-[120px]">
        <div className="container">
          ...
          >
            <Link href="#">
            <button className="duration-80 mb-4 cursor-pointer rounded-md border border-transparent bg-primary py-3 px-6 text-center text-base font-medium text-white outline-none transition ease-in-out hover:bg-opacity-80 hover:shadow-signUp focus-visible:shadow-none">View All</button>
            </Link>
