...
// https://script.google.com/macros/s/AKfycbyMXDYYG0hMwHis5G6FeYmcHNox1PpfpG-Ly6WzwACKhNyqvhz-wZlk54C8F7R6x6f02w/exec
const NewsLatterBox = () => {

    const formRef = useRef(null)
    const scriptUrl = "https://script.google.com/macros/s/AKfycbyMXDYYG0hMwHis5G6FeYmcHNox1PpfpG-Ly6WzwACKhNyqvhz-wZlk54C8F7R6x6f02w/exec"
  ...
  return (
    ...
    >
      ...
      Stay Informed and Inspired with Our Latest Updates - Subscribe to Stunly Agency&lsquo;s Newsletter.
      </p>
      <form ref={formRef} onSubmit={handleSubmit} name="google-sheet">
        ...
        <button
          ...
          >
            {loading ? <div className="loading-button">Loading<span className="loader"></span></div> : "Subscribe"}
        </button>
